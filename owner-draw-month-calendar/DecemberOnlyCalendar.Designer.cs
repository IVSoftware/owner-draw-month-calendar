...
{
    partial class DecemberOnlyCalendar
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            buttonYearUp = new Label();
            buttonYearDown = new Label();
            labelYear = new Label();
            ...
            tableLayoutPanel.Controls.Add(tableLayoutPanelHeader, 0, 0);
            ...
            tableLayoutPanelHeader.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 66.6666641F));
            tableLayoutPanelHeader.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 16.666666F));
            tableLayoutPanelHeader.Controls.Add(buttonYearUp, 2, 0);
            tableLayoutPanelHeader.Controls.Add(buttonYearDown, 0, 0);
            tableLayoutPanelHeader.Controls.Add(labelYear, 1, 0);
        ...
        private Label buttonYearUp;
        private Label buttonYearDown;
